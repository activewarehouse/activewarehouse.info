...
class Project
  ...
  def self.all
    [
      ['activewarehouse-etl', '1.0.0', '2012-06-20T00:00:00Z', 'A highly hackable Ruby ETL (Extract/Transform/Load) tool. <br/>Tested with MRI 1.9.3, 1.8.7, MySQL and Postgresql.<br/>Requires ActiveRecord 3+.'],
      ['adapter_extensions', '1.0.0', '2012-06-20T00:00:00Z', 'ActiveRecord extensions for bulk load and tables manipulations. <br/>Tested with MRI 1.9.3, 1.8.7, MySQL and Postgresql.<br/>Requires ActiveRecord 3+.'], 
